    ...
    return (
        <Container maxWidth="md" sx={{mt: 8}}>
            ...
            <Typography variant="subtitle1" align="center" paragraph sx={{mt: 4}}>
                ...
                (Фон содействия инновациям)» по итогам конкурса в рамках программы «Студенческий стартап»,
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={4}>
                    ...
                    <Typography variant="body1" align="center">
                        <strong>Фаттахов Ильяс Маратович:</strong> Фаттахов Ильяс Маратович
                ...
                <Grid item xs={12} md={4}>
                    ...
                    />
                    <Typography variant="body1" align="center">
                        <strong>Горобец Елена Анатольевна:</strong> Научный руководитель стартаппроекта, доцент, канд. филол.
